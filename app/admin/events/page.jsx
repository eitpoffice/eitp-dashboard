...
export default function WebsiteEditor() {
  ...
  const handlePublish = async () => {
    ...
    // FORMATTING: Ensure empty strings are sent as NULL to the database to keep them truly "optional"
    const finalEventData = { 
      ...newEvent, 
      type: newEvent.type === "Custom" ? customType : newEvent.type,
      start_date: newEvent.start_date || null,
      deadline: newEvent.deadline || null,
      // Fallback: secretly save start_date to the old date column to prevent database errors
